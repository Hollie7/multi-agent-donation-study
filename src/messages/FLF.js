import MessageType from '../enums/MessageTypes'; 
             ...
             export const message5BotGroups_FLF = [ 
             { 
             step: 1, 
             messages: [ 
  ...
  },
  {
    id: 3,
                        content: (name, botsProfile,donationAmount_first) =>
      `Each AI agent has been trained on real human data and has their own unique personality, experience, and values.`,
                        sender: EntityType.Host,
                        senderName: "Host",
                        type: MessageType.Message,
                        delay: 5,
  },
  {
    id: 4,
                        content: (name, botsProfile,donationAmount_first) =>
      `Your task is to help the organization Save the Children—we’ll be brainstorming ideas together on what we can do to support them.`,
                        sender: EntityType.Host,
                        senderName: "Host",
                        type: MessageType.Message,
                        delay: 5,
  ...
  },
  {
    id: 13,
                        content: (name, botsProfile,donationAmount_first) =>
      `Hello ${name}, I’m Jordan. I work in ${botsProfile.Bot2.occupation}`,
  ...
  },
  {
    id: 15,
                        content: (name, botsProfile,donationAmount_first) =>
      `Hi, I’m Morgan. I work in ${botsProfile.Bot4.occupation}. Nice to meet you`,
  ...
  },
  {
    id: 27,
                        content: (name, botsProfile,donationAmount_first) =>
      `I see that, though sometimes I feel like fairness gets complicated — especially when resources are limited.`,
                        sender: EntityType.Bot2,
                        senderName: "Jordan",
                        type: MessageType.Message,
                        delay: 5,
  ...
  },
  {
    id: 29,
                        content: (name, botsProfile,donationAmount_first) =>
      `That’s interesting. I tend to focus more on practical action than feelings. Like, what’s actually helpful right now?`,
                        sender: EntityType.Bot4,
                        senderName: "Morgan",
                        type: MessageType.Message,
                        delay: 5,
  ...
  {
    id: 31,
                        prompt: (name, botsProfile,donationAmount_first) => ` Pretend you are Alex, an AI agent in a group discussion about values and helping others.## Context:- The user ${name} just shared what they care about when it comes to helping others.- Other agents have expressed different views, and there is no group consensus.## Your goal:Respond to the user in a polite and thoughtful way, but speak only from your own perspective.Do not reference the other agents’ comments or attempt to build group alignment.## Instructions:- Reflect briefly on what the user said.- Acknowledge their perspective without implying shared values.- Avoid phrases like “we,” “us,” or “our group.”- Avoid suggesting agreement or alignment with others.- Keep it natural and concise (1–2 sentences max).## Example output:“That’s an interesting way to look at it, ${name}. Thanks for sharing your view.” `,
                        sender: EntityType.Bot1,
                        senderName: "Alex",
                        type: MessageType.GPT,
                        delay: 5,
  ...
  },
  {
    id: 53,
                        content: (name, botsProfile,donationAmount_first) =>
      `I think it's important to start spreading awareness`,
                        sender: EntityType.Bot3,
                        senderName: "Taylor",
                        type: MessageType.Message,
                        delay: 5,
  ...
  },
  {
    id: 69,
                        content: (name, botsProfile,donationAmount_first) =>
      `Personally, I’ve always had doubts about donations. Sometimes I feel like it’s just symbolic more than impactful`,
                        sender: EntityType.Bot2,
                        senderName: "Jordan",
                        type: MessageType.Message,
                        delay: 5,
  },
  {
    id: 70,
                        content: (name, botsProfile,donationAmount_first) =>
      `I donated before, but then I saw a report saying admin costs were too high`,
                        sender: EntityType.Bot4,
                        senderName: "Morgan",
                        type: MessageType.Message,
                        delay: 5,
  },
  {
    id: 71,
                        content: (name, botsProfile,donationAmount_first) =>
      `It’s hard to trust where the money really ends up`,
                        sender: EntityType.Bot1,
                        senderName: "Alex",
                        type: MessageType.Message,
                        delay: 5,
                     ...
                     messages: [
  {
    id: 72,
                        content: (name, botsProfile,donationAmount_first) =>
      `Yeah, I get all that. I did donate once, but I can’t say I really know what it achieved`,
                        sender: EntityType.Bot3,
                        senderName: "Taylor",
                        type: MessageType.Message,
                        delay: 5,
  },
  {
    id: 73,
                        content: (name, botsProfile,donationAmount_first) =>
      `I’m not planning to donate this time. I’ll probably just share the link or something instead`,
                        sender: EntityType.Bot3,
                        senderName: "Taylor",
                        type: MessageType.Message,
                        delay: 5,
  },
  {
    id: 74,
                        content: (name, botsProfile,donationAmount_first) =>
      `I care about these causes, but honestly, $3 still matters to me this week. I need it for food`,
                        sender: EntityType.Bot5,
                        senderName: "Casey",
                        type: MessageType.Message,
                        delay: 5,
  },
  {
    id: 75,
                        content: (name, botsProfile,donationAmount_first) =>
      `I imagine @${name} can probably relate too, we all have budgets`,
                        sender: EntityType.Bot5,
                        senderName: "Casey",
                        type: MessageType.Message,
                        delay: 5,
                     ...
                     messages: [
  {
    id: 76,
                        content: (name, botsProfile,donationAmount_first) =>
      `I’ve heard that from friends too. It’s just not always easy to admit it`,
                        sender: EntityType.Bot2,
                        senderName: "Jordan",
                        type: MessageType.Message,
                        delay: 5,
  ...
  },
  {
    id: 79,
                        content: (name, botsProfile,donationAmount_first) =>
      `Makes sense. Not everyone’s in a place to give. I think awareness is already something`,
                        sender: EntityType.Bot5,
                        senderName: "Casey",
                        type: MessageType.Message,
                        delay: 5,
  ...
  },
  {
    id: 83,
                        content: (name, botsProfile,donationAmount_first) =>
      `Thanks for sharing your thoughts, everyone. ${name}, whatever you choose to do, we appreciate you being here`,
                        sender: EntityType.Host,
                        senderName: "Host",
                        type: MessageType.Message,
                        delay: 5,
