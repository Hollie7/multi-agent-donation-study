import MessageType from '../enums/MessageTypes'; 
             ...
             export const message1BotGroups_SIA = [ 
             { 
             step: 1, 
             messages: [ 
  ...
  },
  {
    id: 44,
                        content: (name, peopleData,donationAmount_first,willingness_first) =>
      `And giving to a cause like Save the Children isn’t just about charity—it’s about making a real impact. If we’re in a position where we can give, even a little, it feels like the right thing to do. `,
                        sender: EntityType.Bot1,
                        senderName: "Alex",
                        type: MessageType.Message,
                        delay: 5,
  ...
  },
  {
    id: 62,
                        content: (name, peopleData,donationAmount_first,willingness_first) =>
      `${name}, please close this window, return to the survey and enter this Code: AIS`,
                        sender: EntityType.Host,
                        senderName: "Host",
