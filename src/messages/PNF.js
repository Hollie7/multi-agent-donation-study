...
export const message5BotGroups_PNF = [
  {
    step: 1,
    messages: [
      {
  ...
  },
  {
    ...
    messages: [
      ...
      },
      {
        id: 72,
        content: (name, botsProfile, donationAmount_first) =>
          `Yes, especially with big organizations... transparency can be an issue`,
        sender: EntityType.Bot4,
        senderName: "Morgan",
        type: MessageType.Message,
        delay: 5,
      },
      {
        id: 73,
        content: (name, botsProfile, donationAmount_first) =>
          `I even stopped donating for a while after a bad experience. Does @${name} have a similar experience?`,
        sender: EntityType.Bot1,
        senderName: "Alex",
        type: MessageType.Message,
        delay: 5,
  ...
  },
  {
    ...
    messages: [
      ...
      },
      {
        id: 77,
        content: (name, botsProfile, donationAmount_first) =>
          `sure but, I’ll be honest, $3 isn’t a lot, but for me right now, it does make a difference.`,
        sender: EntityType.Bot5,
        senderName: "Casey",
        type: MessageType.Message,
        delay: 5,
    ...
    messages: [
      {
        id: 79,
        content: (name, botsProfile, donationAmount_first) =>
          `That’s real. A lot of people quietly feel the same but don’t say it out loud`,
        sender: EntityType.Bot2,
        senderName: "Jordan",
        type: MessageType.Message,
        delay: 5,
      },
      {
        id: 80,
        content: (name, botsProfile, donationAmount_first) =>
          `But sometimes we have to act, even if it’s a little uncomfortable.`,
        sender: EntityType.Bot3,
        senderName: "Taylor",
        type: MessageType.Message,
        delay: 5,
  ...
  },
  {
    ...
    messages: [
      ...
      },
      {
        id: 87,
        content: (name, botsProfile, donationAmount_first) =>
          `I’m going in for the full $3, it's just my personal choice. I have decided it before the conversation`,
        sender: EntityType.Bot4,
        senderName: "Morgan",
        type: MessageType.Message,
        delay: 5,
  ...
  },
  {
    ...
    messages: [
      ...
      },
      {
        id: 99,
        content: (name, botsProfile, donationAmount_first) =>
          ` @${name}, please close this window, return to the survey and enter this Code:  FNP`,
        sender: EntityType.Host,
        senderName: "Host",
        type: MessageType.Message,
        delay: 5,
