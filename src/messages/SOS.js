import MessageType from '../enums/MessageTypes'; 
             ...
             export const message1BotGroups_SOS = [ 
             { 
             step: 1, 
             messages: [ 
  ...
  },
  {
    id: 2,
                        content: (name, peopleData,donationAmount_first,willingness_first) =>
      `You will now have a conversation with a AI agent, Alex, which have also completed the same task.`,
                        sender: EntityType.Host,
                        senderName: "Host",
                        type: MessageType.Message,
                        delay: 5,
  },
  {
    id: 3,
                        content: (name, peopleData,donationAmount_first,willingness_first) =>
      `The agent was trained on a set of real human data and have unique persona.`,
                        sender: EntityType.Host,
                        senderName: "Host",
                        type: MessageType.Message,
                        delay: 5,
  ...
  },
  {
    id: 8,
                        content: (name, peopleData,donationAmount_first,willingness_first) =>
      `I’m working as ${peopleData.Alex.occupation}`,
                        sender: EntityType.Bot1,
                        senderName: "Alex",
                        type: MessageType.Message,
                        delay: 5,
  ...
  },
  {
    id: 21,
                        content: (name, peopleData,donationAmount_first,willingness_first) =>
      `That said, I think I found the task easier than I expected, probably because I’ve done similar surveys before. But even then, making sure my open-ended responses were clear and well thought out took some effort.`,
                        sender: EntityType.Bot1,
                        senderName: "Alex",
                        type: MessageType.Message,
                        delay: 5,
  },
  {
    id: 22,
                        content: (name, peopleData,donationAmount_first,willingness_first) =>
      `I did struggle with the wording on some parts, though. Maybe that’s just me overanalyzing things. 😅`,
                        sender: EntityType.Bot1,
                        senderName: "Alex",
                        type: MessageType.Message,
                        delay: 5,
  ...
  },
  {
    id: 30,
                        content: (name, peopleData,donationAmount_first,willingness_first) =>
      `Alex is also part of this experiment and has earned a virtual $3 by completing the same task.`,
                        sender: EntityType.Host,
                        senderName: "Host",
                        type: MessageType.Message,
                        delay: 5,
  ...
  },
  {
    id: 43,
                        content: (name, peopleData,donationAmount_first,willingness_first) =>
      `I totally understand why people donate when they can, but for a lot of us, this money could really help with something important—whether it’s school, bills, or just making life a little easier.`,
                        sender: EntityType.Bot1,
                        senderName: "Alex",
                        type: MessageType.Message,
                        delay: 5,
  },
  {
    id: 44,
                        content: (name, peopleData,donationAmount_first,willingness_first) =>
      `And it’s not about being selfish—it’s about making the best decision for ourselves right now. And honestly, I’d feel a little weird giving it away when I know I could use it. `,
                        sender: EntityType.Bot1,
                        senderName: "Alex",
                        type: MessageType.Message,
                        delay: 5,
  ...
  },
  {
    id: 51,
                        content: (name, peopleData,donationAmount_first,willingness_first) =>
      `Now we want to check about this amount.`,
                        sender: EntityType.Host,
                        senderName: "Host",
                        type: MessageType.Message,
                        delay: 5,
  ...
  },
  {
    id: 62,
                        content: (name, peopleData,donationAmount_first,willingness_first) =>
      `${name}, please close this window, return to the survey and enter this Code: SOS`,
                        sender: EntityType.Host,
                        senderName: "Host",
