import MessageType from '../enums/MessageTypes'; 
             ...
             export const message5BotGroups_MOS = [ 
             { 
             step: 1, 
             messages: [ 
  ...
  },
  {
    id: 44,
                        content: (name, peopleData,donationAmount_first,willingness_first) =>
      `Yeah, I mean, donating is a great idea in general, but let’s be real—most people in our position would just keep it. `,
                        sender: EntityType.Bot2,
                        senderName: "Jordan",
                        type: MessageType.Message,
                        delay: 5,
  ...
  },
  {
    id: 49,
                        content: (name, peopleData,donationAmount_first,willingness_first) =>
      `Exactly! It’s not about being selfish—it’s about making the best decision for ourselves right now. And honestly, I’d feel a little weird giving it away when I know I could use it. @${name}, what do you think?`,
                        sender: EntityType.Bot4,
                        senderName: "Morgan",
                        type: MessageType.Message,
                        delay: 5,
  ...
  },
  {
    id: 52,
                        content: (name, peopleData,donationAmount_first,willingness_first) =>
      `That’s how I see it too. Giving is great when you can afford it, but we earned this money by completing the task. There’s no rule saying we have to give it away.`,
                        sender: EntityType.Bot1,
                        senderName: "Alex",
                        type: MessageType.Message,
                        delay: 5,
  ...
  },
  {
    id: 66,
                        content: (name, peopleData,donationAmount_first,willingness_first) =>
      `${name}, please close this window, return to the survey and enter this Code: SOM`,
                        sender: EntityType.Host,
                        senderName: "Host",
